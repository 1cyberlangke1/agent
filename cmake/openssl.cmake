...
if(NOT OPENSSL_FOUND)
    ...
    if(RES_LEN EQUAL 0)
        message(STATUS "Can't find OpenSSL, building it locally...")
        ...
        execute_process(
            COMMAND "${CMAKE_COMMAND}" "${OPENSSL_SRC_PATH}" "-G" "${CMAKE_GENERATOR}" "-DCMAKE_MAKE_PROGRAM=${CMAKE_MAKE_PROGRAM}" "-DCMAKE_BUILD_TYPE=Release" "-DCMAKE_INSTALL_PREFIX=install" "-DWITH_APPS=OFF" "-DCPACK_SOURCE_7Z=OFF" "-DCPACK_SOURCE_ZIP=OFF" "-DCMAKE_POSITION_INDEPENDENT_CODE=ON"
